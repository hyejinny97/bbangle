...
const VARIANT_CLASS = {
  ...
  'secondary-white': 'px-[10px] py-[6px] bg-gray-100 rounded-full text-xs',
  'secondary-black': 'px-[10px] py-[6px] bg-gray-800 rounded-full text-xs',
  input:
    'disabled:text-gray-500 px-[11.5px] py-[6px] text-xs rounded-[8px] bg-gray-700 text-white disabled:bg-gray-200'
};
